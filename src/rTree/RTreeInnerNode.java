...
public class RTreeInnerNode<T extends Polygon> extends RTreeNode<T>  implements Serializable
{
	/**
	 * 
	 */
	 ...
	 * @param recordReference which that inserted key is located
	 ...
	 */
	private void insertAt(int index, Polygon key) 
	{
	 ...
	 */
	public void insertLeftAt(int index, Polygon key, RTreeNode<T> leftChild) 
	{
		insertAt(index, key);
	 ...
	 */
	public void insertRightAt(int index, Polygon key, RTreeNode<T> rightChild)
	{
		insertAt(index, key);
	 ...
	 */
	public void merge(Polygon parentKey, RTreeInnerNode<T> foreignNode)
	{
